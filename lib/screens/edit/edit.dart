...
class EditStudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   context.read<DataProvider>().fnameController.text = context.read<DataProvider>().allStudents[index].firstName;
    context.read<DataProvider>().lnameController.text = context.read<DataProvider>().allStudents[index].lastName;
    context.read<DataProvider>().placeController.text = context.read<DataProvider>().allStudents[index].place;
    context.read<DataProvider>().phoneController.text = context.read<DataProvider>().allStudents[index].phone;
    context.read<DataProvider>().mailidController.text = context.read<DataProvider>().allStudents[index].mail;
    return Scaffold(
      appBar: AppBar(
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                  ...
                  onChanged: (value) {
                        context.read<DataProvider>().fnameKey
                        .currentState!
                        .validate();
                  },
              ...
              TextFormField(
                  ...
                  onChanged: (value) {
                   context.read<DataProvider>().lnameKey
                        .currentState!
                        .validate();
                  },
                  decoration: const InputDecoration(
              ...
              TextFormField(
                ...
                onChanged: (value) {
                 context.read<DataProvider>().phoneKey
                      .currentState!
                      .validate();
                },
              ...
              TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<DataProvider>().mailidKey
                        .currentState!
                        .validate();
                  },
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (context.read<DataProvider>().formKey
                      .currentState!
                      .validate()) {
                    context.read<DataProvider>().updateStudent(context.read<DataProvider>().allStudents[index].id!);
